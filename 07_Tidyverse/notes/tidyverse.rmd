...
![](dplyr.png){width=55% fig-align="center"}
...
![](select.png){width=70% fig-align="center"}
...
![](filter.png){width=70% fig-align="center"}
...
![](mutate.png){width=70% fig-align="center"}
...
![](summarize.png){width=60% fig-align="center"}

## `group_by()` — splits data into groups

![](group_by.png){width=40% fig-align="center"}
...
![](wide_vs_long.png){width=65% fig-align="center"}
...
![](pivot_longer_data.png){width=90% fig-align="center"}
...
![](different-types-of-joins-in-R.png){width=60% fig-align="center"}

## Data joining — examples
